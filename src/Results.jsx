...
function Results(props) {
    ...
    return (
        <>
            <div className={`flex flex-wrap -mt-10 mb-10 md:gap-8 justify-center xs:w-3/4 md:w-5/6 lg:w-3/5 mx-auto sm:p-16 p-8 ${themeColors.component.bckgd} ${themeColors.text} shadow-xl shadow-blue-500/20 border-none rounded-3xl`}>
                <div className="block w-full">
                    <div className="flex justify-between items-center">
                        ...
                        <div>
                            <h3 className={`text-4xl font-questrial p-8 ${themeColors.title.bckgd}`}>Your {numberOfConversions.number} Cosmic {numberOfConversions.grammar}</h3>
                        </div>
                    </div>
                </div>
                <div className="block p-8 bg-orange-100 rounded-xl">
